    ...
    <footer className="p-4 bg-white md:p-8 lg:p-10 border-t">
      <div className="mx-auto max-w-screen-xl text-center">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase">Download</h2>
            <ul className="text-gray-500 font-medium">
              <li className="mb-2">
        ...
        <div className="flex flex-col items-center justify-center sm:flex-row sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center mb-4 sm:mb-0">
            © 2023 <Link href="/" className="hover:underline">BankSecure™</Link>. All Rights Reserved.
          </span>
